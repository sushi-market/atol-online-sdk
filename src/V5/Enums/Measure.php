...
enum Measure: int
{
    ...
    public function getDescription(): string
    {
        return match ($this) {
            ...
            self::DECIMETER => 'Дециметр',
            self::METER => 'Метр',
            self::SQUARE_CENTIMETER => 'Квадратный сантиметр',
            self::SQUARE_DECIMETER => 'Квадратный дециметр',
            self::SQUARE_METER => 'Квадратный метр',
            self::MILLILITER => 'Миллилитр',
            self::LITER => 'Литр',
            self::CUBIC_METER => 'Кубический метр',
            self::KILOWATT_HOUR => 'Киловатт час',
            self::GIGACALORIE => 'Гигакалория',
            self::DAY => 'Сутки (день)',
            self::HOUR => 'Час',
            self::MINUTE => 'Минута',
            self::SECOND => 'Секунда',
            ...
            self::OTHER => 'Иная единица измерения',
        };
    }
}
